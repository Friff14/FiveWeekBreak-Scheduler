...
var CampusListComponent = (function () {
    function CampusListComponent(_campusService) {
        this._campusService = _campusService;
        this.pageTitle = 'Campus List';
    }
    CampusListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._campusService.getCampuses()
            .subscribe(function (campuses) { return _this.campuses = campuses; }, function (error) { return console.log('get error: ', error); });
    };
